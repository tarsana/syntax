...
class ObjectSyntaxTest extends TestCase {
  public function test_getters_and_setters() {
    $syntax = (new ObjectSyntax(['name' => S\arr()], '|'))->fields(['name' => S\string()])->field('age', S\number());
  ...
  public function test_to_string() {
    ...
    $this->assertEquals(
      "Object {name: String, age: Number, is_programmer: Boolean, friends: Array of (String) separated by ','} separated by ':'",
      "{$syntax}"
    );
  }
