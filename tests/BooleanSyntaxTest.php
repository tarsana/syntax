...
class BooleanSyntaxTest extends TestCase {
  public function test_parse() {
    $this->assertParse(S\boolean(), [
      ...
      [
        'input' => 'wrong boolean',
        'errors' => ["Error while parsing 'wrong boolean' as Boolean at character 0: " . BooleanSyntax::PARSE_ERROR],
      ],
    ]);
  }
  ...
  public function test_dump() {
    $this->assertDump(S\boolean(), [
      ...
      [
        'input' => [15, 'string'],
        'errors' => ['Error while dumping some input as Boolean: ' . BooleanSyntax::DUMP_ERROR],
      ],
    ]);
  }
}
